...
export class HomepageService {
  ...
  getPremiereList(userID?: string): Observable<PremiereAlbum[]> {
    ...
    return this.http.get<any>(`${API_ROOT}/MainPage/premiere-albums`, { params }).pipe(
      map(data => {
  ...
  getEventList(userID?: string): Observable<Event[]> {
    ...
    return this.http.get<any>(`${API_ROOT}/MainPage/events`, { params }).pipe(
      map(data => {
  ...
  getSideRecommendations(userID?: string): Observable<HomepageSideRecommendations> {
    ...
    return this.http.get<any>(`${API_ROOT}/MainPage/side-recommendations`, { params }).pipe(
      map(data => {
        return {
          topDiscussions: {
